...
type fakeRewardSvc struct {
	createFn         func(ctx context.Context, req *rewardservice.CreateRewardRequest) (*domain.Reward, error)
	updateFn         func(ctx context.Context, id int64, req *rewardservice.UpdateRewardRequest) (*domain.Reward, error)
	deleteFn         func(ctx context.Context, id int64) error
	getByIDFn        func(ctx context.Context, id int64) (*domain.Reward, error)
	listBySeasonFn func(ctx context.Context, seasonID int64) ([]domain.Reward, error)
}

func (f *fakeRewardSvc) Create(ctx context.Context, req *rewardservice.CreateRewardRequest) (*domain.Reward, error) {
	if f.createFn != nil {
		return f.createFn(ctx, req)
	}
	return &domain.Reward{ID: 1}, nil
}

func (f *fakeRewardSvc) Update(ctx context.Context, id int64, req *rewardservice.UpdateRewardRequest) (*domain.Reward, error) {
	if f.updateFn != nil {
		return f.updateFn(ctx, id, req)
	}
	return &domain.Reward{ID: id}, nil
}
...
func (f *fakeRewardSvc) GetByID(ctx context.Context, id int64) (*domain.Reward, error) {
	if f.getByIDFn != nil {
...
func (f *fakeRewardSvc) ListBySeason(ctx context.Context, seasonID int64) ([]domain.Reward, error) {
...
func TestRewardHandler_List(t *testing.T) {
	t.Run("returns 200 with rewards", func(t *testing.T) {
		handler := newRewardHandler(&fakeRewardSvc{
			listBySeasonFn: func(_ context.Context, _ int64) ([]domain.Reward, error) {
				return []domain.Reward{{ID: 1}}, nil
			},
		})
...
func TestRewardHandler_Get(t *testing.T) {
	t.Run("returns 200 with reward", func(t *testing.T) {
		handler := newRewardHandler(&fakeRewardSvc{
			getByIDFn: func(_ context.Context, id int64) (*domain.Reward, error) {
				return &domain.Reward{ID: id}, nil
			},
		})
	...
	t.Run("returns 404 when not found", func(t *testing.T) {
		handler := newRewardHandler(&fakeRewardSvc{
			getByIDFn: func(_ context.Context, _ int64) (*domain.Reward, error) { return nil, nil },
		})
	...
	t.Run("returns 500 when service fails", func(t *testing.T) {
		handler := newRewardHandler(&fakeRewardSvc{
			getByIDFn: func(_ context.Context, _ int64) (*domain.Reward, error) {
				return nil, errors.New("db error")
			},
		})
...
func TestRewardHandler_Create(t *testing.T) {
	t.Run("returns 201 with created reward", func(t *testing.T) {
		handler := newRewardHandler(&fakeRewardSvc{
			createFn: func(_ context.Context, _ *rewardservice.CreateRewardRequest) (*domain.Reward, error) {
				return &domain.Reward{ID: 7}, nil
			},
		})
...
func TestRewardHandler_Update(t *testing.T) {
	t.Run("returns 200 with updated reward", func(t *testing.T) {
		handler := newRewardHandler(&fakeRewardSvc{
			updateFn: func(_ context.Context, id int64, _ *rewardservice.UpdateRewardRequest) (*domain.Reward, error) {
				return &domain.Reward{ID: id}, nil
			},
		})
	...
	t.Run("returns 404 when not found", func(t *testing.T) {
		handler := newRewardHandler(&fakeRewardSvc{
			updateFn: func(_ context.Context, _ int64, _ *rewardservice.UpdateRewardRequest) (*domain.Reward, error) {
