...
type fakeSeasonSvc struct {
	createFn    func(ctx context.Context, req *seasonservice.CreateRequest) (*domain.Season, error)
	updateFn    func(ctx context.Context, id int64, req *seasonservice.UpdateRequest) (*domain.Season, error)
	deleteFn    func(ctx context.Context, id int64) error
	getActiveFn func(ctx context.Context) (*domain.Season, error)
}

func (f *fakeSeasonSvc) Create(ctx context.Context, req *seasonservice.CreateRequest) (*domain.Season, error) {
	if f.createFn != nil {
		return f.createFn(ctx, req)
	}
	return &domain.Season{ID: 1, Title: req.Title}, nil
}

func (f *fakeSeasonSvc) Update(ctx context.Context, id int64, req *seasonservice.UpdateRequest) (*domain.Season, error) {
	if f.updateFn != nil {
...
func (f *fakeSeasonSvc) GetActive(ctx context.Context) (*domain.Season, error) {
...
func (f *fakeSeasonSvc) GetByID(ctx context.Context, id int64) (*domain.Season, error) {
	return nil, nil
}

func (f *fakeSeasonSvc) List(ctx context.Context) ([]*domain.Season, error) {
	return nil, nil
}

func (f *fakeSeasonSvc) ListActive(ctx context.Context) ([]*domain.Season, error) {
	return nil, nil
}
...
func TestSeasonHandler_Create(t *testing.T) {
	t.Run("returns 201 with created season", func(t *testing.T) {
		handler := newSeasonHandler(&fakeSeasonSvc{
			createFn: func(_ context.Context, req *seasonservice.CreateRequest) (*domain.Season, error) {
				return &domain.Season{ID: 42, Title: req.Title, IsActive: req.IsActive}, nil
			},
		})
	...
	t.Run("returns 500 when service fails", func(t *testing.T) {
		handler := newSeasonHandler(&fakeSeasonSvc{
			createFn: func(_ context.Context, _ *seasonservice.CreateRequest) (*domain.Season, error) {
...
func TestSeasonHandler_GetActive(t *testing.T) {
	t.Run("returns 200 with active season", func(t *testing.T) {
		now := time.Now()
		handler := newSeasonHandler(&fakeSeasonSvc{
			getActiveFn: func(_ context.Context) (*domain.Season, error) {
				return &domain.Season{ID: 5, Title: "Active", StartDate: now}, nil
			},
		})
	...
	t.Run("returns 404 when no active season", func(t *testing.T) {
		handler := newSeasonHandler(&fakeSeasonSvc{
			getActiveFn: func(_ context.Context) (*domain.Season, error) { return nil, nil },
		})
		w := do(t, handler, http.MethodGet, "/active", nil)
...
func TestSeasonHandler_Update(t *testing.T) {
	t.Run("returns 200 with updated season", func(t *testing.T) {
		newTitle := "Updated"
		handler := newSeasonHandler(&fakeSeasonSvc{
			updateFn: func(_ context.Context, id int64, req *seasonservice.UpdateRequest) (*domain.Season, error) {
				return &domain.Season{ID: id, Title: *req.Title}, nil
			},
		})
	...
	t.Run("returns 404 when season not found", func(t *testing.T) {
		handler := newSeasonHandler(&fakeSeasonSvc{
			updateFn: func(_ context.Context, _ int64, _ *seasonservice.UpdateRequest) (*domain.Season, error) {
