...
type fakeTaskSvc struct {
	createFn         func(ctx context.Context, req *taskservice.CreateRequest) (*domain.Task, error)
	updateFn         func(ctx context.Context, id int64, req *taskservice.UpdateRequest) (*domain.Task, error)
	deleteFn         func(ctx context.Context, id int64) error
	getByIDFn        func(ctx context.Context, id int64) (*domain.Task, error)
	listBySeasonFn func(ctx context.Context, seasonID int64) ([]domain.Task, error)
}

func (f *fakeTaskSvc) Create(ctx context.Context, req *taskservice.CreateRequest) (*domain.Task, error) {
	if f.createFn != nil {
...
func (f *fakeTaskSvc) Update(ctx context.Context, id int64, req *taskservice.UpdateRequest) (*domain.Task, error) {
	if f.updateFn != nil {
...
func (f *fakeTaskSvc) GetByID(ctx context.Context, id int64) (*domain.Task, error) {
	if f.getByIDFn != nil {
...
func (f *fakeTaskSvc) ListBySeason(ctx context.Context, seasonID int64) ([]domain.Task, error) {
...
func TestTaskHandler_List(t *testing.T) {
	t.Run("returns 200 with tasks", func(t *testing.T) {
		handler := newTaskHandler(&fakeTaskSvc{
			listBySeasonFn: func(_ context.Context, seasonID int64) ([]domain.Task, error) {
				return []domain.Task{{ID: 1, SeasonID: seasonID}}, nil
			},
		})
	...
	t.Run("returns 500 when service fails", func(t *testing.T) {
		handler := newTaskHandler(&fakeTaskSvc{
			listBySeasonFn: func(_ context.Context, _ int64) ([]domain.Task, error) {
...
func TestTaskHandler_Get(t *testing.T) {
	t.Run("returns 200 with task", func(t *testing.T) {
		handler := newTaskHandler(&fakeTaskSvc{
			getByIDFn: func(_ context.Context, id int64) (*domain.Task, error) {
				return &domain.Task{ID: id, Title: "My Task"}, nil
			},
		})
	...
	t.Run("returns 404 when not found", func(t *testing.T) {
		handler := newTaskHandler(&fakeTaskSvc{
			getByIDFn: func(_ context.Context, _ int64) (*domain.Task, error) { return nil, nil },
		})
...
func TestTaskHandler_Create(t *testing.T) {
	t.Run("returns 201 with created task", func(t *testing.T) {
		handler := newTaskHandler(&fakeTaskSvc{
			createFn: func(_ context.Context, req *taskservice.CreateRequest) (*domain.Task, error) {
				return &domain.Task{ID: 10, Title: req.Title}, nil
			},
		})
	...
	t.Run("returns 500 when service fails", func(t *testing.T) {
		handler := newTaskHandler(&fakeTaskSvc{
			createFn: func(_ context.Context, _ *taskservice.CreateRequest) (*domain.Task, error) {
				return nil, errors.New("db error")
			},
		})
...
func TestTaskHandler_Update(t *testing.T) {
	t.Run("returns 200 with updated task", func(t *testing.T) {
		handler := newTaskHandler(&fakeTaskSvc{
			updateFn: func(_ context.Context, id int64, req *taskservice.UpdateRequest) (*domain.Task, error) {
				return &domain.Task{ID: id, Title: *req.Title}, nil
			},
		})
	...
	t.Run("returns 404 when not found", func(t *testing.T) {
		handler := newTaskHandler(&fakeTaskSvc{
			updateFn: func(_ context.Context, _ int64, _ *taskservice.UpdateRequest) (*domain.Task, error) {
