...
type fakeClaimSvc struct {
	submitClaimFn       func(ctx context.Context, userID, seasonID, rewardID int64) (*rewarddomain.RewardClaim, error)
	updateClaimStatusFn func(ctx context.Context, claimID int64, req *rewardservice.UpdateClaimRequest, seasonID int64) (*rewarddomain.RewardClaim, error)
...
func (f *fakeClaimSvc) SubmitClaim(ctx context.Context, userID, seasonID, rewardID int64) (*rewarddomain.RewardClaim, error) {
	if f.submitClaimFn != nil {
		return f.submitClaimFn(ctx, userID, seasonID, rewardID)
	}
	return &rewarddomain.RewardClaim{ID: 1}, nil
}

func (f *fakeClaimSvc) UpdateClaimStatus(ctx context.Context, claimID int64, req *rewardservice.UpdateClaimRequest, seasonID int64) (*rewarddomain.RewardClaim, error) {
	if f.updateClaimStatusFn != nil {
		return f.updateClaimStatusFn(ctx, claimID, req, seasonID)
	}
	return &rewarddomain.RewardClaim{ID: claimID}, nil
}

func (f *fakeClaimSvc) GetClaimByID(ctx context.Context, id int64) (*rewarddomain.RewardClaim, error) {
	if f.getClaimByIDFn != nil {
		return f.getClaimByIDFn(ctx, id)
	}
	return &rewarddomain.RewardClaim{ID: id}, nil
}

func (f *fakeClaimSvc) ListClaimsByUser(ctx context.Context, userID int64) ([]rewarddomain.RewardClaim, error) {
	if f.listClaimsByUserFn != nil {
		return f.listClaimsByUserFn(ctx, userID)
	}
	return []rewarddomain.RewardClaim{}, nil
}

func (f *fakeClaimSvc) ListAllClaims(_ context.Context) ([]rewarddomain.RewardClaim, error) {
	return nil, nil
}
...
func TestClaimHandler_Submit(t *testing.T) {
	t.Run("returns 201 on success", func(t *testing.T) {
		handler := newClaimHandler(&fakeClaimSvc{
			submitClaimFn: func(_ context.Context, _, _, _ int64) (*rewarddomain.RewardClaim, error) {
				return &rewarddomain.RewardClaim{ID: 5}, nil
			},
		})
...
func TestClaimHandler_List(t *testing.T) {
	t.Run("returns 200 with own claims", func(t *testing.T) {
		handler := newClaimHandler(&fakeClaimSvc{
			listClaimsByUserFn: func(_ context.Context, userID int64) ([]rewarddomain.RewardClaim, error) {
				return []rewarddomain.RewardClaim{{ID: 1, UserID: userID}}, nil
			},
		})
	...
	t.Run("returns 200 filtered by user_id param", func(t *testing.T) {
		handler := newClaimHandler(&fakeClaimSvc{
			listClaimsByUserFn: func(_ context.Context, userID int64) ([]rewarddomain.RewardClaim, error) {
				return []rewarddomain.RewardClaim{{ID: 2, UserID: userID}}, nil
			},
		})
	...
	t.Run("returns 500 when service fails", func(t *testing.T) {
		handler := newClaimHandler(&fakeClaimSvc{
			listClaimsByUserFn: func(_ context.Context, _ int64) ([]rewarddomain.RewardClaim, error) {
				return nil, errors.New("db error")
			},
		})
		w := claimDo(t, handler, http.MethodGet, "/", nil, defaultSess)
...
func TestClaimHandler_Get(t *testing.T) {
	...
	t.Run("returns 404 when not found", func(t *testing.T) {
		handler := newClaimHandler(&fakeClaimSvc{
			getClaimByIDFn: func(_ context.Context, _ int64) (*rewarddomain.RewardClaim, error) { return nil, nil },
		})
...
func TestClaimHandler_UpdateStatus(t *testing.T) {
	t.Run("returns 200 with updated claim", func(t *testing.T) {
		handler := newClaimHandler(&fakeClaimSvc{
			updateClaimStatusFn: func(_ context.Context, claimID int64, _ *rewardservice.UpdateClaimRequest, _ int64) (*rewarddomain.RewardClaim, error) {
				return &rewarddomain.RewardClaim{ID: claimID}, nil
			},
		})
	...
	t.Run("returns 404 when not found", func(t *testing.T) {
		handler := newClaimHandler(&fakeClaimSvc{
			updateClaimStatusFn: func(_ context.Context, _ int64, _ *rewardservice.UpdateClaimRequest, _ int64) (*rewarddomain.RewardClaim, error) {
