...
type fakeSubmissionSvc struct {
	createFn     func(ctx context.Context, reviewerID int64, req *submissionservice.CreateRequest) (*submissiondomain.TaskSubmission, error)
...
func (f *fakeSubmissionSvc) Create(ctx context.Context, reviewerID int64, req *submissionservice.CreateRequest) (*submissiondomain.TaskSubmission, error) {
	if f.createFn != nil {
...
func (f *fakeSubmissionSvc) GetByID(ctx context.Context, id int64) (*submissiondomain.TaskSubmission, error) {
	if f.getByIDFn != nil {
		return f.getByIDFn(ctx, id)
	}
	return &submissiondomain.TaskSubmission{ID: id}, nil
}

func (f *fakeSubmissionSvc) ListByUser(ctx context.Context, userID int64) ([]submissiondomain.TaskSubmission, error) {
	if f.listByUserFn != nil {
		return f.listByUserFn(ctx, userID)
	}
	return []submissiondomain.TaskSubmission{}, nil
}

func (f *fakeSubmissionSvc) ListAll(_ context.Context) ([]submissiondomain.TaskSubmission, error) {
	return nil, nil
}

func (f *fakeSubmissionSvc) Submit(_ context.Context, _ int64, _ *submissionservice.SubmitRequest) (*submissiondomain.TaskSubmission, error) {
	return nil, nil
}

func (f *fakeSubmissionSvc) Approve(_ context.Context, _, _ int64) (*submissiondomain.TaskSubmission, error) {
	return nil, nil
}

func (f *fakeSubmissionSvc) Reject(_ context.Context, _, _ int64, _ string) (*submissiondomain.TaskSubmission, error) {
	return nil, nil
}
...
type fakeUserSvcSub struct{}

func (f *fakeUserSvcSub) GetById(_ context.Context, id int64) (*userdomain.User, error) {
	return &userdomain.User{ID: id, Name: "Test User"}, nil
}
...
func newSubmissionHandler(svc *fakeSubmissionSvc) http.Handler {
	h := submissionapi.NewHandler(svc, &fakeUserSvcSub{}, slog.New(slog.NewTextHandler(io.Discard, nil)))
	r := chi.NewRouter()
	...
	t.Run("returns 200 with own submissions", func(t *testing.T) {
		handler := newSubmissionHandler(&fakeSubmissionSvc{
			listByUserFn: func(_ context.Context, userID int64) ([]submissiondomain.TaskSubmission, error) {
				return []submissiondomain.TaskSubmission{{ID: 1, UserID: userID}}, nil
			},
		})
	...
	t.Run("returns 200 filtered by user_id param", func(t *testing.T) {
		handler := newSubmissionHandler(&fakeSubmissionSvc{
			listByUserFn: func(_ context.Context, _ int64) ([]submissiondomain.TaskSubmission, error) {
				return []submissiondomain.TaskSubmission{{ID: 2}}, nil
			},
		})
...
func TestSubmissionHandler_Get(t *testing.T) {
	t.Run("returns 200 with submission", func(t *testing.T) {
		handler := newSubmissionHandler(&fakeSubmissionSvc{
			getByIDFn: func(_ context.Context, id int64) (*submissiondomain.TaskSubmission, error) {
				return &submissiondomain.TaskSubmission{ID: id}, nil
			},
		})
	...
	t.Run("returns 404 when not found", func(t *testing.T) {
		handler := newSubmissionHandler(&fakeSubmissionSvc{
			getByIDFn: func(_ context.Context, _ int64) (*submissiondomain.TaskSubmission, error) { return nil, nil },
		})
...
func TestSubmissionHandler_Create(t *testing.T) {
	t.Run("returns 201 with reviewer id from session", func(t *testing.T) {
		...
		handler := newSubmissionHandler(&fakeSubmissionSvc{
			createFn: func(_ context.Context, reviewerID int64, _ *submissionservice.CreateRequest) (*submissiondomain.TaskSubmission, error) {
	...
	t.Run("returns 500 when service fails", func(t *testing.T) {
		handler := newSubmissionHandler(&fakeSubmissionSvc{
			createFn: func(_ context.Context, _ int64, _ *submissionservice.CreateRequest) (*submissiondomain.TaskSubmission, error) {
				return nil, errors.New("db error")
			},
		})
