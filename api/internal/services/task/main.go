...
// without importing taskdomain.
var (
	ErrNotFound     = taskdomain.ErrNotFound
	ErrHasRelations = taskdomain.ErrHasRelations
)

type taskRepo interface {
	Insert(ctx context.Context, t *taskdomain.Task) error
	Update(ctx context.Context, t *taskdomain.Task, columns ...string) error
...
func (s *TaskService) Create(ctx context.Context, req *CreateRequest) (*taskdomain.Task, error) {
...
func (s *TaskService) Update(ctx context.Context, id int64, req *UpdateRequest) (*taskdomain.Task, error) {
...
func (s *TaskService) ListBySeason(ctx context.Context, seasonID int64) ([]taskdomain.Task, error) {
