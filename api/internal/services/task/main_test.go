...
type fakeTaskRepo struct {
	insertFn       func(ctx context.Context, t *taskdomain.Task) error
	updateFn       func(ctx context.Context, t *taskdomain.Task, columns ...string) error
...
func (f *fakeTaskRepo) Insert(ctx context.Context, t *taskdomain.Task) error {
	if f.insertFn != nil {
...
func (f *fakeTaskRepo) Update(ctx context.Context, t *taskdomain.Task, columns ...string) error {
	if f.updateFn != nil {
...
func (f *fakeTaskRepo) GetByID(ctx context.Context, id int64) (*taskdomain.Task, error) {
	if f.getByIDFn != nil {
...
func (f *fakeTaskRepo) ListBySeason(ctx context.Context, seasonID int64) ([]taskdomain.Task, error) {
...
func existingTask() *taskdomain.Task {
...
func TestTaskService_Create(t *testing.T) {
	...
	t.Run("defaults metadata to {} when empty", func(t *testing.T) {
		...
		repo := &fakeTaskRepo{
			insertFn: func(_ context.Context, t *taskdomain.Task) error {
	...
	t.Run("propagates repo insert error", func(t *testing.T) {
		...
		svc := newTaskService(&fakeTaskRepo{
			insertFn: func(_ context.Context, _ *taskdomain.Task) error {
				return repoErr
			},
		})
...
func TestTaskService_Update(t *testing.T) {
	t.Run("updates only provided fields", func(t *testing.T) {
		...
		repo := &fakeTaskRepo{
			...
			updateFn: func(_ context.Context, _ *taskdomain.Task, columns ...string) error {
	...
	t.Run("no-op when no fields provided — repo Update not called", func(t *testing.T) {
		...
		repo := &fakeTaskRepo{
			...
			updateFn: func(_ context.Context, _ *taskdomain.Task, _ ...string) error {
				updateCalled = true
				return nil
			},
		}
	...
	t.Run("returns domain task when found", func(t *testing.T) {
		repo := &fakeTaskRepo{
			getByIDFn: func(_ context.Context, id int64) (*taskdomain.Task, error) {
				...
				return &taskdomain.Task{ID:          42, Title: "Found Task"}, nil
			},
		}
